...
public class Empresa {
	  public static void main(String[] args) {
          ...
          System.out.println("\nNombre Depto " + "\tLocalidad " + "\tNumero Depto ");
          ...
          System.out.println("\nNombre Depto " + "\tLocalidad " + "\tN�mero Depto ");
       ...
       // Los vuelvo a cargar en la lista
          ...
          System.out.println("200 euros mas salario del depto 30\n");
          ...
          AccesoMetaDatos.infoTablas("empresa","departamentos",conexion);
          AccesoMetaDatos.infoConsulta("SELECT * FROM empleados JOIN departamentos ON empleados.dept_no=departamentos.dept_no",conexion);
