...
public class EscribirFicheroCaracter2 {
	public static void main(String[] args) {
		...
		try {
			...
			// archivo que
			// se especifica en su constructor (el fichero no tiene por que
			// existir)
			...
			// Ahora leemos de la entrada estandar
			int c;
			while ((c = System.in.read()) != -1) {
				escribir.write(c);
			}
			// Ctrl-Z debe ir en una linea solo (la linea donde se detecta no se
			// escribira)
