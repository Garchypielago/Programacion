package serializables2Err;
/*
 * Escribimos dos objetos en un fichero y a continuacion los leemos.
 * Creamos un par de objetos mas y los aniadimos al fichero. Vemos que da error 
 * al leer el fichero de nuevo:
 * java.io.StreamCorruptedException: invalid type code: AC
 * 
 * Borramos el fichero antiguo para que no interfiera en el resultado
 * 
 * */
import java.io.*;
