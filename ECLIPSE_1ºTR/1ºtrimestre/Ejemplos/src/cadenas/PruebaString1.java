...
//        
        ...
        System.out.println(cadena.indexOf("i", 30));  //Nos devuelve la posicion de la primera i desde la posici�n 30
        System.out.println();
    	...
    	System.out.println("***********");
    	System.out.println();   	
        //que marca el segundo parametro, a su derecha
        System.out.println(cadena.lastIndexOf("i"));  //Nos devuelve el contenido de la posicion de la �ltima i (72)       
        System.out.println(cadena.lastIndexOf("i", 30));  //Nos devuelve la posicion de la �ltima i a la izquierda de la posici�n
        System.out.println();
        ...
        System.out.println("Posicion de la primera ocurrencia de la palabra su " + pos); //localiza la posicion donde se encuentra "su"
        pos = cadena.indexOf("su", pos+1);
        System.out.println();
        System.out.println("**************************************************");
        System.out.println("Posicion de la segunda ocurrencia de la palabra su " + pos); //localiza la posicion donde se encuentra la segunda "su"
        ...
        // Ojo que la original no cambia si no lo provocamos nosotros guardandolo en la cadena
        System.out.println("*********");
