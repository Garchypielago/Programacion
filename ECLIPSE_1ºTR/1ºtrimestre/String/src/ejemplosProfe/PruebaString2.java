...
public class PruebaString2 {
	public static void main(String[] args) {
        ...
        System.out.println();
        String str="Tomas";		//Le da un valor
        System.out.println("*********");
	    System.out.println("Orden alfabetico "+str.compareTo("Alberto"));
	    System.out.println();
  	    str="Alberto";			//le cambia el valor y sigue con este str
  	    System.out.println("*********");
		...
		System.out.println();
		System.out.println(nombre.concat(" Lopez")); //probar a concatenar con objeto
